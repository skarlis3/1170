...
ENGL 1170 — First-Year Writing Co-Req, paired with ENGL 1181. See `work-with-claude-code/classes/ENGL-1170/CLAUDE.md` for course context.
...
**One HTML file per date, named `YYYY-MM-DD.html`.** Add the entry in the same session as the change — the reasoning is what the log is for, and it evaporates fast. Full spec in `classes/CLAUDE.md` under "Class Website Change Logs."
